...
### Ảnh 1: Giao diện trực quan hóa báo cáo chiến lược chi tiết
<p align="center">
...
<p align="center">
  <img src="docs/images/screenshot1.jpg" alt="Kết quả báo cáo chi tiết" width="85%">
</p>

### Ảnh 2: Bản vẽ sơ đồ kiến trúc hệ thống Microservices
<p align="center">
...
<p align="center">
  <img src="docs/images/screenshot2.jpg" alt="Bản vẽ sơ đồ kiến trúc hệ thống Microservices" width="85%">
</p>

### Ảnh 3: Giao diện từ chối câu hỏi ngoài phạm vi — Tab Báo Cáo Chi Tiết
<p align="center">
  Màn hình ghi nhận hành vi của hệ thống khi lọc ngữ cảnh và từ chối các câu hỏi nằm ngoài phạm vi chuyên môn. Tác nhân Lọc ngữ cảnh xác định truy vấn không hợp lệ và đi thẳng tới kết thúc đồ thị (END Node) để bảo vệ tài nguyên. Tab Báo Cáo Chi Tiết hiển thị thẻ từ chối với tiêu đề "BÁO CÁO KHÔNG ÁP DỤNG", Chỉ Số Vận Hành vẫn giữ nguyên hiển thị bình thường với trạng thái "Bị Từ Chối".
</p>
<p align="center">
  <img src="docs/images/screenshot3.jpg" alt="Từ chối câu hỏi ngoài phạm vi — Báo Cáo" width="85%">
</p>

### Ảnh 4: Giao diện từ chối câu hỏi ngoài phạm vi — Tab Sơ Đồ Quy Trình
<p align="center">
  Cùng một truy vấn bị từ chối, chuyển sang tab Sơ Đồ Quy Trình hiển thị thẻ từ chối tương ứng với tiêu đề "SƠ ĐỒ KHÔNG ÁP DỤNG". Cơ chế định tuyến thông minh tự động dừng xử lý ngay tại Guardrail Agent, chỉ sử dụng 1/6 tác nhân để tối ưu hóa hiệu suất hệ thống.
</p>
<p align="center">
