...
MODEL_ANALYST_AGENT      = "gemma3:27b"         # Advanced reasoning for trade-offs & complex evaluation matrix (free)
MODEL_RISK_ASSESSOR_AGENT= "gemma3:27b"         # Advanced reasoning for compliance & multi-dimensional risk matrix (free)
